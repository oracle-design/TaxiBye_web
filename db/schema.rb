...
ActiveRecord::Schema.define(version: 20170125191644) do
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.index ["trip_id"], name: "index_ratings_on_trip_id", using: :btree
  end
  ...
  create_table "taxis", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at",                                           null: false
    t.datetime "updated_at",                                           null: false
    t.index ["plate_number"], name: "index_taxis_on_plate_number", unique: true, using: :btree
  end
